...
-----------------------------------------------
	...
	("en_US",	"LOC_CIVILIZATION_CVS_TAINO_NAME",			"Taíno"					),
	("en_US",	"LOC_CIVILIZATION_CVS_TAINO_DESCRIPTION",	"Taíno Civilization"	),
	("en_US",	"LOC_CIVILIZATION_CVS_TAINO_ADJECTIVE",  	"Taíno"					),
	
-----------------------------------------------
-- UA
-----------------------------------------------

	("en_US",	"LOC_TRAIT_CIVILIZATION_CVS_TAINO_UA_NAME",  "Guatiao"	),
	("en_US",	"LOC_TRAIT_CIVILIZATION_CVS_TAINO_UA_DESCRIPTION",	"Type bonuses from allied City-States are doubled."	),
	
-----------------------------------------------
-- UU
-----------------------------------------------

	("en_US",	"LOC_UNIT_CVS_TAINO_UU_NAME",	"Macana"	),
	("en_US",	"LOC_UNIT_CVS_TAINO_UU_DESCRIPTION",	  
	"A recon unit unique to Taíno. Replaces the warrior and retains its earned Recon [ICON_PROMOTION] Promotions on upgrade. Upon eliminating an enemy unit, earns [ICON_FAITH] Faith equal to half the [ICON_STRENGTH] Combat Strength of the defeated unit."),

-----------------------------------------------
-- UI
-----------------------------------------------

	("en_US",	"LOC_DISTRICT_CVS_TAINO_UI_NAME",	"Batéy"	),
	("en_US",	"LOC_DISTRICT_CVS_TAINO_UI_DESCRIPTION",	
	"An Entertainment Complex replacement unique to Taíno. Buildings within this district provide +1 [ICON_AMENITIES] Amenity. Allows the city to start the Areyto Ceremony city project, which provides +1 [ICON_INFLUENCEPERTURN] Influence points per turn and [ICON_GREATPERSON] Great Person points for Great [ICON_GreatWriter] Writers, [ICON_GreatArtist] Artists and [ICON_GreatMusician] Musicians upon completion."	),

-----------------------------------------------
-- UP
-----------------------------------------------

	("en_US",	"LOC_PROJECT_CVS_TAINO_UP_NAME",		"Areyto Ceremony"	),
	("en_US",	"LOC_PROJECT_CVS_TAINO_UP_SHORTNAME",	"Areyto Ceremony"	),
...
-----------------------------------------------
	...
	("en_US",	"LOC_NAMED_MOUNTAIN_GUANIGUANICO",	"Guaniguanico"	),
	("en_US",	"LOC_NAMED_MOUNTAIN_BAORUCO",		"Baoruco"		),

-----------------------------------------------
-- Rivers
-----------------------------------------------

	("en_US",	"LOC_NAMED_MOUNTAIN_ARTIBONITE",	"Artibonite"	),
...
-----------------------------------------------
	...
	("en_US",	"LOC_CITY_NAME_YAGUANA", "Yaguana"),
	("en_US",	"LOC_CITY_NAME_GUARICO", "Guárico"),
	("en_US",	"LOC_CITY_NAME_MAGUA", "Maguá"),
	("en_US",	"LOC_CITY_NAME_MAGUANA", "Maguana"),
	("en_US",	"LOC_CITY_NAME_HIGUEY", "Higüey"),
	("en_US",	"LOC_CITY_NAME_YAUCO", "Yauco"),
	("en_US",	"LOC_CITY_NAME_GUAYNIA", "Guaynía"),
	("en_US",	"LOC_CITY_NAME_TOA", "Toa"),
	("en_US",	"LOC_CITY_NAME_ARASIBO", "Arasibo"),
	("en_US",	"LOC_CITY_NAME_AYMAMON", "Aymamón"),
	("en_US",	"LOC_CITY_NAME_CAYNIABON", "Cayniabón"),
	("en_US",	"LOC_CITY_NAME_TURABO", "Turabo"),
	("en_US",	"LOC_CITY_NAME_SEBUCO", "Sebuco"),
	("en_US",	"LOC_CITY_NAME_GUAYANEY", "Guayaney"),
	("en_US",	"LOC_CITY_NAME_GUAYAMA", "Guayama"),
	("en_US",	"LOC_CITY_NAME_OTOAO", "Otoao"),
	("en_US",	"LOC_CITY_NAME_MACAO", "Macao"),
	("en_US",	"LOC_CITY_NAME_GUAJATACA", "Guajataca"),
	("en_US",	"LOC_CITY_NAME_BAYAMON", "Bayamón"),
	("en_US",	"LOC_CITY_NAME_GUAYNABO", "Guaynabo"),
	("en_US",	"LOC_CITY_NAME_YAGUECAS", "Yagüecas"),
	("en_US",	"LOC_CITY_NAME_DAGUAO", "Daguao"),
	("en_US",	"LOC_CITY_NAME_JAYMANIO", "Jaymanío"),
	("en_US",	"LOC_CITY_NAME_COABEY", "Coabey"),
	("en_US",	"LOC_CITY_NAME_CAYEY", "Cayey"),
	("en_US",	"LOC_CITY_NAME_JATIBONICU", "Jatibonicu"),
	("en_US",	"LOC_CITY_NAME_BIEKE", "Bieke"),
	("en_US",	"LOC_CITY_NAME_ABEYNO", "Abeyno"),
	("en_US",	"LOC_CITY_NAME_HOROMICO", "Horomico"),
	("en_US",	"LOC_CITY_NAME_MAYGUEZ", "Maygüez"),
	("en_US",	"LOC_CITY_NAME_BARACOA", "Baracoa"),
	("en_US",	"LOC_CITY_NAME_CAMAGUEY", "Camagüey"),
	("en_US",	"LOC_CITY_NAME_YABUCOA", "Yabucoa"),
	("en_US",	"LOC_CITY_NAME_HAYUYA", "Hayuya"),
	("en_US",	"LOC_CITY_NAME_CAMUY", "Camuy"),
	("en_US",	"LOC_CITY_NAME_BAYAMO", "Bayamo"),
	("en_US",	"LOC_CITY_NAME_AMONA", "Ámona"),
	("en_US",	"LOC_CITY_NAME_GONAIBO", "Gonaibo"),
	("en_US",	"LOC_CITY_NAME_GUANTANAMO", "Guantánamo"),
	("en_US",	"LOC_CITY_NAME_ABAWANA", "Abawana"),
	("en_US",	"LOC_CITY_NAME_GUANABO", "Guanabo"),
	("en_US",	"LOC_CITY_NAME_YAQUIMEL", "Yaquimel"),

-----------------------------------------------
-- Citizens
-----------------------------------------------
	
	("en_US",	"LOC_CITIZEN_CVS_TAINO_MALE_1",		"Ameyro"	),
	("en_US",	"LOC_CITIZEN_CVS_TAINO_MALE_2",		"Aymaco"	),
	("en_US",	"LOC_CITIZEN_CVS_TAINO_MALE_3",		"Comerio"	),
	("en_US",	"LOC_CITIZEN_CVS_TAINO_MALE_4",		"Cajaya"	),
	("en_US",	"LOC_CITIZEN_CVS_TAINO_MALE_5",		"Kaiman"	),
	("en_US",	"LOC_CITIZEN_CVS_TAINO_MALE_6",		"Kakata"	),
	("en_US",	"LOC_CITIZEN_CVS_TAINO_MALE_7",		"Guey"		),
	("en_US",	"LOC_CITIZEN_CVS_TAINO_MALE_8",		"Karaya"	),
	("en_US",	"LOC_CITIZEN_CVS_TAINO_MALE_9",		"Acanorex"	),
	("en_US",	"LOC_CITIZEN_CVS_TAINO_MALE_10",	"Majagua"	),
	("en_US",	"LOC_CITIZEN_CVS_TAINO_FEMALE_1",	"Anani"		),
	("en_US",	"LOC_CITIZEN_CVS_TAINO_FEMALE_2",	"Guama"		),
	("en_US",	"LOC_CITIZEN_CVS_TAINO_FEMALE_3",	"Liren"		),
	("en_US",	"LOC_CITIZEN_CVS_TAINO_FEMALE_4",	"Yabisi"	),
	("en_US",	"LOC_CITIZEN_CVS_TAINO_FEMALE_5",	"Colibri"	),
	("en_US",	"LOC_CITIZEN_CVS_TAINO_FEMALE_6",	"Tonina"	),
	("en_US",	"LOC_CITIZEN_CVS_TAINO_FEMALE_7",	"Nimita"	),
	("en_US",	"LOC_CITIZEN_CVS_TAINO_FEMALE_8",	"Tinima"	),
	("en_US",	"LOC_CITIZEN_CVS_TAINO_FEMALE_9",	"Casiguaya"	),
	("en_US",	"LOC_CITIZEN_CVS_TAINO_FEMALE_10",	"Yuisa"		),
	
-----------------------------------------------
-- Info
-----------------------------------------------

	("en_US",	"LOC_CIVINFO_CVS_TAINO_LOCATION",		"Caribbean"			),
	("en_US",	"LOC_CIVINFO_CVS_TAINO_SIZE",			"c.200,000 km²"		),
	("en_US",	"LOC_CIVINFO_CVS_TAINO_POPULATION",		"600,000 - 1 million (est.)"	),
	("en_US",	"LOC_CIVINFO_CVS_TAINO_CAPITAL",		"Various tribal capitals"	),

-----------------------------------------------
-- Pedia
-----------------------------------------------

	("en_US",	"LOC_PEDIA_CIVILIZATIONS_PAGE_CIVILIZATION_CVS_TAINO_CHAPTER_HISTORY_PARA_1",	
	...
	("en_US",	"LOC_PEDIA_CIVILIZATIONS_PAGE_CIVILIZATION_CVS_TAINO_CHAPTER_HISTORY_PARA_2",	
	...
	("en_US",	"LOC_PEDIA_CIVILIZATIONS_PAGE_CIVILIZATION_CVS_TAINO_CHAPTER_HISTORY_PARA_3",	
	...
	("en_US",	"LOC_PEDIA_CIVILIZATIONS_PAGE_CIVILIZATION_CVS_TAINO_CHAPTER_HISTORY_PARA_4",	
	...
	("en_US",	"LOC_PEDIA_CIVILIZATIONS_PAGE_CIVILIZATION_CVS_TAINO_CHAPTER_HISTORY_PARA_5",	
	...
	("en_US",	"LOC_PEDIA_CIVILIZATIONS_PAGE_CIVILIZATION_CVS_TAINO_CHAPTER_HISTORY_PARA_6",	
	...
	("en_US",	"LOC_PEDIA_CIVILIZATIONS_PAGE_CIVILIZATION_CVS_TAINO_CHAPTER_HISTORY_PARA_7",	
	...
	("en_US",	"LOC_PEDIA_CIVILIZATIONS_PAGE_CIVILIZATION_CVS_TAINO_CHAPTER_HISTORY_PARA_8",	
	...
	("en_US",	"LOC_PEDIA_CIVILIZATIONS_PAGE_CIVILIZATION_CVS_TAINO_CHAPTER_HISTORY_PARA_9",	
	...
	("en_US",	"LOC_PEDIA_CIVILIZATIONS_PAGE_CIVILIZATION_CVS_TAINO_CHAPTER_HISTORY_PARA_10",	
	...
	("en_US",	"LOC_PEDIA_CIVILIZATIONS_PAGE_CIVILIZATION_CVS_TAINO_CHAPTER_HISTORY_PARA_11",	
	...
	("en_US",	"LOC_PEDIA_CIVILIZATIONS_PAGE_CIVILIZATION_CVS_TAINO_CHAPTER_HISTORY_PARA_12",	
	...
	("en_US",	"LOC_PEDIA_CIVILIZATIONS_PAGE_CIVILIZATION_CVS_TAINO_CHAPTER_HISTORY_PARA_13",	
	...
	("en_US",	"LOC_PEDIA_CIVILIZATIONS_PAGE_CIVILIZATION_CVS_TAINO_CHAPTER_HISTORY_PARA_14",	
	...
	("en_US",	"LOC_PEDIA_DISTRICTS_PAGE_DISTRICT_CVS_TAINO_UI_CHAPTER_HISTORY_PARA_1",	
	...
	("en_US",	"LOC_PEDIA_DISTRICTS_PAGE_DISTRICT_CVS_TAINO_UI_CHAPTER_HISTORY_PARA_2",	
	...
	("en_US",	"LOC_PEDIA_DISTRICTS_PAGE_DISTRICT_CVS_TAINO_UI_CHAPTER_HISTORY_PARA_3",	
	...
	("en_US",	"LOC_PEDIA_DISTRICTS_PAGE_DISTRICT_CVS_TAINO_UI_CHAPTER_HISTORY_PARA_4",	
	...
	("en_US",	"LOC_PEDIA_DISTRICTS_PAGE_DISTRICT_CVS_TAINO_UI_CHAPTER_HISTORY_PARA_5",	
	...
	("en_US",	"LOC_PEDIA_DISTRICTS_PAGE_DISTRICT_CVS_TAINO_UI_CHAPTER_HISTORY_PARA_6",	
	...
	("en_US",	"LOC_PEDIA_DISTRICTS_PAGE_DISTRICT_CVS_TAINO_UI_CHAPTER_HISTORY_PARA_7",	
	...
	("en_US",	"LOC_PEDIA_DISTRICTS_PAGE_DISTRICT_CVS_TAINO_UI_CHAPTER_HISTORY_PARA_8",	
	...
	("en_US",	"LOC_PEDIA_PROJECTS_PAGE_PROJECT_CVS_TAINO_UP_CHAPTER_HISTORY_PARA_1",	
	...
	("en_US",	"LOC_PEDIA_PROJECTS_PAGE_PROJECT_CVS_TAINO_UP_CHAPTER_HISTORY_PARA_2",	
	...
	("en_US",	"LOC_PEDIA_PROJECTS_PAGE_PROJECT_CVS_TAINO_UP_CHAPTER_HISTORY_PARA_3",	
	...
	("en_US",	"LOC_PEDIA_PROJECTS_PAGE_PROJECT_CVS_TAINO_UP_CHAPTER_HISTORY_PARA_4",	
	...
	("en_US",	"LOC_PEDIA_PROJECTS_PAGE_PROJECT_CVS_TAINO_UP_CHAPTER_HISTORY_PARA_5",	
	...
	("en_US",	"LOC_PEDIA_PROJECTS_PAGE_PROJECT_CVS_TAINO_UP_CHAPTER_HISTORY_PARA_6",	
	...
	("en_US",	"LOC_PEDIA_PROJECTS_PAGE_PROJECT_CVS_TAINO_UP_CHAPTER_HISTORY_PARA_7",	
	...
	("en_US",	"LOC_PEDIA_PROJECTS_PAGE_PROJECT_CVS_TAINO_UP_CHAPTER_HISTORY_PARA_8",	
	...
	("en_US",	"LOC_PEDIA_PROJECTS_PAGE_PROJECT_CVS_TAINO_UP_CHAPTER_HISTORY_PARA_9",	
	...
	("en_US",	"LOC_PEDIA_PROJECTS_PAGE_PROJECT_CVS_TAINO_UP_CHAPTER_HISTORY_PARA_10",	
	...
	("en_US",	"LOC_PEDIA_PROJECTS_PAGE_PROJECT_CVS_TAINO_UP_CHAPTER_HISTORY_PARA_11",	
	...
	("en_US",	"LOC_PEDIA_PROJECTS_PAGE_PROJECT_CVS_TAINO_UP_CHAPTER_HISTORY_PARA_12",	
	...
	("en_US",	"LOC_PEDIA_PROJECTS_PAGE_PROJECT_CVS_TAINO_UP_CHAPTER_HISTORY_PARA_13",	
	...
	("en_US",	"LOC_PEDIA_UNITS_PAGE_UNIT_CVS_TAINO_UU_CHAPTER_HISTORY_PARA_1",  
	"The term macana, of Taíno origin, refers to wooden weapons used by the various native cultures of Central and South America. The earliest meaning attributed to macana is a sword-like weapon made out of wood, but still sharp enough to be dangerous. The term is also sometimes applied to the similar Aztec weapon, which is studded with pieces of obsidian in order to create a blade, though some authorities distinguish this item by using the Nahuatl name macuahuitl."),

-----------------------------------------------
-- Mod Support (Rule with Faith)
-----------------------------------------------

	("en_US",	"LOC_CIVILIZATION_CVS_ROMANIA_DESCRIPTION_JFD_CIVILIZATION",					"Taino Civilization"		),
	("en_US",	"LOC_GOVERNMENT_JFD_EMPIRE_LEADER_TITLE_CVS_ROMANIA",							"Cacique"					),
	("en_US",	"LOC_GOVERNMENT_JFD_EMPIRE_LEADER_TITLE_CVS_ROMANIA_FEMININE",					"Cacica"					),

	("en_US",	"LOC_GOVERNMENT_JFD_CHIEFDOM_LEADER_TITLE_CVS_ROMANIA",							"Cacique"					),
	("en_US",	"LOC_GOVERNMENT_JFD_CHIEFDOM_LEADER_TITLE_CVS_ROMANIA_FEMININE",				"Cacica"					),
	("en_US",	"LOC_GOVERNMENT_JFD_HORDE_LEADER_TITLE_CVS_ROMANIA",							"Tlacochcalctl"				),
	("en_US",	"LOC_GOVERNMENT_JFD_HORDE_LEADER_TITLE_CVS_ROMANIA_FEMININE",					"Tlacochcalctl"				),
	("en_US",	"LOC_GOVERNMENT_JFD_POLIS_LEADER_TITLE_CVS_ROMANIA",							"Cacique"					),
	("en_US",	"LOC_GOVERNMENT_JFD_POLIS_LEADER_TITLE_CVS_ROMANIA_FEMININE",					"Cacica"					),

	("en_US",	"LOC_GOVERNMENT_JFD_AUTOCRACY_LEADER_TITLE_CVS_ROMANIA",						"Cacique"					),
	("en_US",	"LOC_GOVERNMENT_JFD_AUTOCRACY_LEADER_TITLE_CVS_ROMANIA_FEMININE",				"Cacica"					),
	("en_US",	"LOC_GOVERNMENT_JFD_OLIGARCHY_LEADER_TITLE_CVS_ROMANIA",						"Cacica"					),
	("en_US",	"LOC_GOVERNMENT_JFD_OLIGARCHY_LEADER_TITLE_CVS_ROMANIA_FEMININE",				"Cacica"					),
	("en_US",	"LOC_GOVERNMENT_JFD_CLASSICAL_DEMOCRACY_LEADER_TITLE_CVS_ROMANIA",				"Cacica"					),
	("en_US",	"LOC_GOVERNMENT_JFD_CLASSICAL_DEMOCRACY_LEADER_TITLE_CVS_ROMANIA_FEMININE",		"Cacica"					),

	("en_US",	"LOC_GOVERNMENT_JFD_REPUBLIC_LEADER_TITLE_CVS_ROMANIA",							"Cacique"					),
	("en_US",	"LOC_GOVERNMENT_JFD_REPUBLIC_LEADER_TITLE_CVS_ROMANIA_FEMININE",				"Cacica"					),
	("en_US",	"LOC_GOVERNMENT_JFD_MONARCHY_LEADER_TITLE_CVS_ROMANIA",							"Huetlatoani"				),
	("en_US",	"LOC_GOVERNMENT_JFD_MONARCHY_LEADER_TITLE_CVS_ROMANIA_FEMININE",				"Huetlatoani"				),
	("en_US",	"LOC_GOVERNMENT_JFD_LIBERAL_DEMOCRACY_LEADER_TITLE_CVS_ROMANIA",				"Cacique"					),
	("en_US",	"LOC_GOVERNMENT_JFD_LIBERAL_DEMOCRACY_LEADER_TITLE_CVS_ROMANIA_FEMININE",		"Cacica"					);
